...
class SubthemesTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		$subthemes = array(
			...
			array( 'titre' => 'Principes de procédure', 'categorie_id' => 1, 'theme_id' => 3 , 'schemas' => '25,26,27,28,28-1,29,30,31,32'),
			...
			array( 'titre' => 'Actions collectives', 'categorie_id' => 1, 'theme_id' => 4 , 'schemas' => '48,48-1,49,50,51'),
